...
physical_fighting = st.selectbox('Frekuensi Berkelahi Secara Fisik', 
                                 ('0 kali', '1 kali', '2 atau 3 kali', '4 atau 5 kali', 
                                  '6 atau 7 kali', '8 atau 9 kali', '10 atau 11 kali', '12 kali atau lebih'))
felt_lonely = st.selectbox('Seberapa Sering Merasa Kesepian?', 
...
miss_school = st.selectbox('Tidak Masuk Sekolah Tanpa Izin',
                           ('0 hari', '1 hingga 2 hari', '3 hingga 5 hari', 
                            '6 hingga 9 hari', '10 hari atau lebih'))
kind_helpful_students = st.selectbox('Siswa Lain Baik dan Membantu?', 
                                     ('Tidak Pernah', 'Jarang', 'Kadang-kadang', 'Sering', 'Selalu'))
parents_understand = st.selectbox('Orang Tua Memahami Masalah Saya?', 
                                  ('Tidak Pernah', 'Jarang', 'Kadang-kadang', 'Sering', 'Selalu'))
